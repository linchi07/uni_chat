...
; 侧边条形图 (164x314)
WizardImageFile=build_resources\innoWzImage.png
; 右上角方形标志 (55x55)
WizardSmallImageFile=build_resources\innoWzSmall.png
; 允许图片拉伸以适应不同 DPI
WizardImageStretch=yes
[Languages]
; 配置中英双语支持
Name: "english"; MessagesFile: "compiler:Default.isl"
Name: "chinesesimplified"; MessagesFile: "build_resources\ChineseSimplified.isl"
