...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m7(provider) => "Edit provider:${provider}";

  static String m8(email) => "Email: ${email}";

  static String m9(endPoint) => "EndPoint";

  static String m10(endPoint) => "EndPoint:${endPoint}";

  static String m11(error) => "Error:${error}";

  static String m12(condition) => "while ${condition}";

  static String m13(token) => "Knowledge base(${token}Tokens)";

  static String m14(errorContent) => "Loading error:${errorContent}";

  static String m15(error) => "Failed to read logs: ${error}";

  static String m16(token) => "Longest opening(${token}Tokens)";

  static String m17(percent) => "${percent}% Related";

  static String m18(num) => "Added ${num} models";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "abandon_and_exit":
            MessageLookupByLibrary.simpleMessage("Abandon and Exit"),
        ...
        "agent_override_title":
            MessageLookupByLibrary.simpleMessage("Session Agent Override"),
        ...
        "api_key_exhausted_title":
            MessageLookupByLibrary.simpleMessage("API Key Status Report"),
        ...
        "auto_fetch_models":
            MessageLookupByLibrary.simpleMessage("Auto Fetch Models"),
        "auto_index_rules_1":
        ...
        "create_variant":
            MessageLookupByLibrary.simpleMessage("Create Variant"),
        ...
        "disable_persona":
            MessageLookupByLibrary.simpleMessage("Disable Persona"),
        "discard_changes":
        ...
        "enter_prompt_price":
            MessageLookupByLibrary.simpleMessage("Please enter Prompt price"),
        ...
        "fetching_models":
            MessageLookupByLibrary.simpleMessage("Fetching models..."),
        ...
        "match_conflict":
            MessageLookupByLibrary.simpleMessage("Match Conflict"),
        "match_review_title":
            MessageLookupByLibrary.simpleMessage("Review Model Matches"),
        ...
        "matching_models":
            MessageLookupByLibrary.simpleMessage("Matching models..."),
        ...
        "model_breakdown":
            MessageLookupByLibrary.simpleMessage("Model Breakdown"),
        ...
        "model_param_include_reasoning":
            MessageLookupByLibrary.simpleMessage("Include Reasoning"),
        "model_param_logit_bias":
            MessageLookupByLibrary.simpleMessage("Logit Bias"),
        "model_param_max_tokens":
            MessageLookupByLibrary.simpleMessage("Max Completion Tokens"),
        ...
        "model_param_reasoning":
            MessageLookupByLibrary.simpleMessage("Reasoning"),
        "model_param_repetition_penalty":
            MessageLookupByLibrary.simpleMessage("Repetition Penalty"),
        "model_param_response_format":
            MessageLookupByLibrary.simpleMessage("Response Format"),
        "model_param_seed": MessageLookupByLibrary.simpleMessage("Seed"),
        "model_param_stop":
            MessageLookupByLibrary.simpleMessage("Stop Sequences"),
        "model_param_structured_outputs":
            MessageLookupByLibrary.simpleMessage("Structured Outputs"),
        "model_param_temperature":
            MessageLookupByLibrary.simpleMessage("Temperature"),
        "model_param_tool_choice":
            MessageLookupByLibrary.simpleMessage("Tool Choice"),
        ...
        "model_pricing_settings":
            MessageLookupByLibrary.simpleMessage("Model Pricing Settings"),
        "model_property":
        ...
        "no_data_period":
            MessageLookupByLibrary.simpleMessage("No data in this period"),
        ...
        "no_key_needed":
            MessageLookupByLibrary.simpleMessage("No API Key Needed"),
        ...
        "persona_system_disabled":
            MessageLookupByLibrary.simpleMessage("Persona System Disabled"),
        ...
        "quick_chat_enabled":
            MessageLookupByLibrary.simpleMessage("Quick Chat Enabled"),
        ...
        "select_parameter":
            MessageLookupByLibrary.simpleMessage("Select parameter to add"),
        "select_provider":
