...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "abandon_match_subtitle":
            MessageLookupByLibrary.simpleMessage("尚未保存的匹配结果将会丢失。"),
        "abandon_match_title":
            MessageLookupByLibrary.simpleMessage("确定要放弃本次模型匹配吗？"),
        "about": MessageLookupByLibrary.simpleMessage("关于"),
        "add": MessageLookupByLibrary.simpleMessage("添加"),
        "add_api_key": MessageLookupByLibrary.simpleMessage("添加API密钥"),
        "add_api_key_hint":
            MessageLookupByLibrary.simpleMessage("暂无 API 密钥 \n 请点击右下角+按钮添加"),
        ...
        "add_model_hint":
            MessageLookupByLibrary.simpleMessage("暂无模型\n请点击右下角+按钮添加"),
        ...
        "agentEx_agentNotFound":
            MessageLookupByLibrary.simpleMessage("Agent 未找到"),
        "agentEx_agentNotLoaded":
            MessageLookupByLibrary.simpleMessage("Agent 未被加载"),
        "agentEx_failLoading_parse_error":
            MessageLookupByLibrary.simpleMessage("Agent数据损坏或解析失败"),
        "agentEx_recursive_call":
            MessageLookupByLibrary.simpleMessage("加载Agent"),
        "agentEx_unknownError": MessageLookupByLibrary.simpleMessage("未知错误"),
        "agentEx_versionMismatch":
            MessageLookupByLibrary.simpleMessage("核心组件版本不匹配，请升级应用"),
        ...
        "api_key_exhausted_subtitle":
            MessageLookupByLibrary.simpleMessage("在这一轮请求中，所有可用的 Key 均请求失败："),
        "api_key_exhausted_title":
            MessageLookupByLibrary.simpleMessage("API Key 状态报告"),
        ...
        "auto_index_rules_set":
            MessageLookupByLibrary.simpleMessage("自动索引规则设定"),
        "auto_shrink_large_panel":
            MessageLookupByLibrary.simpleMessage("自动缩小大面板"),
        "avatar_change_hint":
            MessageLookupByLibrary.simpleMessage("点击或拖拽新图片来更换头像"),
        ...
        "branches": m5,
        "cache_price_per_1k":
            MessageLookupByLibrary.simpleMessage("缓存读取价格 (每 1M tokens)"),
        ...
        "chatEx_failParsingMessage":
            MessageLookupByLibrary.simpleMessage("解析聊天消息失败"),
        "chatEx_failToGenerateTitle":
            MessageLookupByLibrary.simpleMessage("自动生成标题失败"),
        "chatEx_failToSaveMessage":
            MessageLookupByLibrary.simpleMessage("储存聊天消息失败"),
        "chatEx_messageNotFound":
            MessageLookupByLibrary.simpleMessage("该会话无消息"),
        "chatEx_modelNotSupportFileType":
            MessageLookupByLibrary.simpleMessage("模型不支持这类文件"),
        "chatEx_recursive_call": MessageLookupByLibrary.simpleMessage("聊天"),
        "chatEx_sessionNotFound":
            MessageLookupByLibrary.simpleMessage("未找到聊天会话"),
        ...
        "choose_agent_and_chat_hint":
            MessageLookupByLibrary.simpleMessage("选择一个Agent并开始聊天吧!"),
        "click_or_drop_files_here":
            MessageLookupByLibrary.simpleMessage("点击选择或拖拽文件到此处"),
        ...
        "completion_price_per_1k":
            MessageLookupByLibrary.simpleMessage("Completion 价格 (每 1M tokens)"),
        ...
        "confirm_adding_model":
            MessageLookupByLibrary.simpleMessage("确认需要添加的模型"),
        "confirm_delete_provider":
            MessageLookupByLibrary.simpleMessage("确定要删除此提供者吗？"),
        "confirm_delete_session":
            MessageLookupByLibrary.simpleMessage("确定要删除此对话记录吗？"),
        ...
        "delete_keys_warning":
            MessageLookupByLibrary.simpleMessage("勾选此项将删除所有现有的 API 密钥。是否继续？"),
        ...
        "embedding_model_note":
            MessageLookupByLibrary.simpleMessage("请注意，该模型是嵌入模型，不能用作文本生成模型。"),
        "enable": MessageLookupByLibrary.simpleMessage("启用"),
        "enable_ui_interactions":
            MessageLookupByLibrary.simpleMessage("启用UI交互功能"),
        "endPoint_might_not_valid":
            MessageLookupByLibrary.simpleMessage("可能无效地址："),
        ...
        "enlarge_context_or_simplify_prompt":
            MessageLookupByLibrary.simpleMessage("扩大模型上下文或简化提示词"),
        "enter_cache_price": MessageLookupByLibrary.simpleMessage("请输入缓存读取价格"),
        "enter_completion_price":
            MessageLookupByLibrary.simpleMessage("请输入 Completion 价格"),
        "enter_end_point": MessageLookupByLibrary.simpleMessage("输入API端点"),
        "enter_key_word_hint":
            MessageLookupByLibrary.simpleMessage("键入关键词用（英文逗号）分割"),
        "enter_knowledge_base_description":
            MessageLookupByLibrary.simpleMessage("输入知识库描述"),
        "enter_knowledge_base_name":
            MessageLookupByLibrary.simpleMessage("输入知识库名称"),
        "enter_opening_here": MessageLookupByLibrary.simpleMessage("在这里输入开场白"),
        "enter_prompt_price":
            MessageLookupByLibrary.simpleMessage("请输入 Prompt 价格"),
        "enter_provider_details":
            MessageLookupByLibrary.simpleMessage("请输入提供商详细信息"),
        ...
        "fill_reminder_null_if_blank":
            MessageLookupByLibrary.simpleMessage("填写备注(留空默认无)"),
        ...
        "front_page_hintLine_char3":
            MessageLookupByLibrary.simpleMessage(" 开始聊天"),
        "front_page_titleSlogan":
            MessageLookupByLibrary.simpleMessage("一起集思广益！"),
        ...
        "generate_title_hint":
            MessageLookupByLibrary.simpleMessage("重新生成会覆盖旧标题"),
        ...
        "give_up_edit_confirm":
            MessageLookupByLibrary.simpleMessage("确定放弃编辑吗？"),
        ...
        "hide_knowledge_base_results":
            MessageLookupByLibrary.simpleMessage("隐藏检索结果"),
        "hide_source_code": MessageLookupByLibrary.simpleMessage("隐藏源码"),
        "hover_to_see_session":
            MessageLookupByLibrary.simpleMessage("鼠标悬停来预览会话"),
        ...
        "keyword_index_hint":
            MessageLookupByLibrary.simpleMessage("当对话中包含关键词的时候，整个内容被发送给模型"),
        ...
        "knowledge_base_and_contexts":
            MessageLookupByLibrary.simpleMessage("知识库&上下文检索"),
        ...
        "language_switch_restart_note":
            MessageLookupByLibrary.simpleMessage("部分更改需要重启App来生效"),
        "limit_model_generate_length":
            MessageLookupByLibrary.simpleMessage("限制模型最大生成长度"),
        "loading_error": m14,
        "log_clear": MessageLookupByLibrary.simpleMessage("清空日志"),
        "log_copied_to_clipboard":
            MessageLookupByLibrary.simpleMessage("已复制日志到剪贴板"),
        "log_copy": MessageLookupByLibrary.simpleMessage("复制日志"),
        "log_enable_global_catch":
            MessageLookupByLibrary.simpleMessage("启用全局日志捕获（重启生效部分拦截）"),
        "log_enable_global_catch_hint":
            MessageLookupByLibrary.simpleMessage("开启后，自动将控制台的输出及未捕获错误记录到本地"),
        ...
        "memory_content_waring":
            MessageLookupByLibrary.simpleMessage("没有内容的记忆不会被添加"),
        "memory_manage": MessageLookupByLibrary.simpleMessage("记忆管理"),
        "memory_name": MessageLookupByLibrary.simpleMessage("记忆名称"),
        "memory_name_waring":
            MessageLookupByLibrary.simpleMessage("没有设置名称的记忆不会被添加"),
        "message_no_content":
            MessageLookupByLibrary.simpleMessage("发生错误，模型返回了一条空消息"),
        ...
        "model_advance_properties":
            MessageLookupByLibrary.simpleMessage("模型高级设置"),
        ...
        "model_configure_not_set":
            MessageLookupByLibrary.simpleMessage("未配置模型"),
        "model_configured": m18,
        "model_context_not_enough":
            MessageLookupByLibrary.simpleMessage("模型上下文不足"),
        ...
        "model_family_hint":
            MessageLookupByLibrary.simpleMessage("请输入模型家族（例如：qwen3）"),
        "model_friendly_name": MessageLookupByLibrary.simpleMessage("模型友好名称"),
        "model_friendly_name_exists":
            MessageLookupByLibrary.simpleMessage("友好名称已存在"),
        "model_friendly_name_hint":
            MessageLookupByLibrary.simpleMessage("请输入模型友好名称（例如：Qwen 7B）"),
        "model_local_telling":
            MessageLookupByLibrary.simpleMessage("告知模型当前用户地区和语言"),
        "model_management": MessageLookupByLibrary.simpleMessage("模型管理"),
        "model_maximum_context_length":
            MessageLookupByLibrary.simpleMessage("模型最大上下文长度"),
        "model_maximum_generate_length":
            MessageLookupByLibrary.simpleMessage("模型最大生成长度"),
        "model_not_found": MessageLookupByLibrary.simpleMessage("未找到模型,请检查输入"),
        "model_or_dimension_not_set":
            MessageLookupByLibrary.simpleMessage("模型或嵌入维度未设置"),
        "model_param_frequency_penalty":
            MessageLookupByLibrary.simpleMessage("频率惩罚"),
        "model_param_include_reasoning":
            MessageLookupByLibrary.simpleMessage("包含推理过程"),
        "model_param_logit_bias":
            MessageLookupByLibrary.simpleMessage("Logit 偏置"),
        "model_param_max_tokens":
            MessageLookupByLibrary.simpleMessage("最大补全 Token 数"),
        "model_param_min_p": MessageLookupByLibrary.simpleMessage("Min P"),
        "model_param_presence_penalty":
            MessageLookupByLibrary.simpleMessage("存在惩罚"),
        "model_param_reasoning": MessageLookupByLibrary.simpleMessage("推理"),
        "model_param_repetition_penalty":
            MessageLookupByLibrary.simpleMessage("重复惩罚"),
        "model_param_response_format":
            MessageLookupByLibrary.simpleMessage("响应格式"),
        "model_param_seed": MessageLookupByLibrary.simpleMessage("随机种子"),
        "model_param_stop": MessageLookupByLibrary.simpleMessage("停止序列"),
        "model_param_structured_outputs":
            MessageLookupByLibrary.simpleMessage("结构化输出"),
        ...
        "model_pricing_settings":
            MessageLookupByLibrary.simpleMessage("模型计价设置"),
        ...
        "model_system_telling":
            MessageLookupByLibrary.simpleMessage("告知模型当前操作系统（如：macos Sonoma）"),
        "model_time_telling":
            MessageLookupByLibrary.simpleMessage("告知模型当前系统时间"),
        "model_unavailable":
            MessageLookupByLibrary.simpleMessage("当前模型不可用，请重新选择模型"),
        "modify_session_name": MessageLookupByLibrary.simpleMessage("修改对话记录名称"),
        "my_api_no_key":
            MessageLookupByLibrary.simpleMessage("我的 API 不需要 API Key"),
        ...
        "no_api_key_added_warning":
            MessageLookupByLibrary.simpleMessage("请先添加 API Key 或勾选“无需密钥”。"),
        ...
        "no_index_method_warning":
            MessageLookupByLibrary.simpleMessage("索引方法未设置，该内容永远不会被插入到对话中"),
        ...
        "no_model_plz_add":
            MessageLookupByLibrary.simpleMessage("没有模型，请前往API设置中添加"),
        "no_models_found":
            MessageLookupByLibrary.simpleMessage("未发现任何模型，请检查 API 配置或端点是否正确。"),
        "no_persona": MessageLookupByLibrary.simpleMessage("没有人格"),
        "no_pop_out_announcement":
            MessageLookupByLibrary.simpleMessage("不再弹出此公告"),
        ...
        "opening_slogan_hint":
            MessageLookupByLibrary.simpleMessage("在无会话时显示的自定义标语"),
        ...
        "personaEX_personaNotFound":
            MessageLookupByLibrary.simpleMessage("人格未找到"),
        ...
        "personaEx_failLoading_parse_error":
            MessageLookupByLibrary.simpleMessage("人格数据无法被解析"),
        "personaEx_recursive_call":
            MessageLookupByLibrary.simpleMessage("加载新人格"),
        "persona_additonal_information":
            MessageLookupByLibrary.simpleMessage("额外人格信息"),
        "persona_description_hint":
            MessageLookupByLibrary.simpleMessage("请介绍一下自己"),
        "persona_system_disabled":
            MessageLookupByLibrary.simpleMessage("人格系统已关闭"),
        "plz_enter": MessageLookupByLibrary.simpleMessage("请输入"),
        "plz_enter_a_number_bigger_than_zero":
            MessageLookupByLibrary.simpleMessage("请输入正数"),
        ...
        "plz_fill_model_call_name":
            MessageLookupByLibrary.simpleMessage("请填写模型调用名"),
        "plz_select_agent": MessageLookupByLibrary.simpleMessage("请选择Agent"),
        "plz_select_embedding_dimension":
            MessageLookupByLibrary.simpleMessage("请选择嵌入维度"),
        ...
        "prompt_price_per_1k":
            MessageLookupByLibrary.simpleMessage("Prompt 价格 (每 1M tokens)"),
        ...
        "regex_index_hint":
            MessageLookupByLibrary.simpleMessage("当对话中的内容匹配正则表达式时，整个内容被发送给模型"),
        ...
        "save_to_agent_settings":
            MessageLookupByLibrary.simpleMessage("将Agent设为所选模型？"),
        "search_any_chat_message":
            MessageLookupByLibrary.simpleMessage("搜索任何聊天内容"),
        ...
        "searched_knowledge_base":
            MessageLookupByLibrary.simpleMessage("检索了知识库"),
        "searching_knowledge_base":
            MessageLookupByLibrary.simpleMessage("正在检索知识库..."),
        "select_agent": MessageLookupByLibrary.simpleMessage("选择Agent"),
        "select_agent_default_persona":
            MessageLookupByLibrary.simpleMessage("使用Agent时的默认人格"),
        ...
        "selected_agent": m21,
        "send_a_message_hint":
            MessageLookupByLibrary.simpleMessage("发送一条消息（支持MD）,键入\"/\"以查看更多选项"),
        "set_as_default": MessageLookupByLibrary.simpleMessage("设为默认"),
        "setup_add_agent":
            MessageLookupByLibrary.simpleMessage("接着，我们来添加一个Agent"),
        "setup_add_agent_hint": MessageLookupByLibrary.simpleMessage(
            "Agent是一个高度自定义的聊天机器人，\\n 通过UNIChat强大的Agent系统，不论是代码大师还是可爱猫娘，随你定义"),
        "setup_add_persona":
            MessageLookupByLibrary.simpleMessage("在添加API之后，让我们添加一个人格"),
        ...
        "setup_api_prepared":
            MessageLookupByLibrary.simpleMessage("我已经准备好API和APIKey了"),
        "setup_finished": MessageLookupByLibrary.simpleMessage("一切皆已就绪！"),
        "setup_finished_btn":
            MessageLookupByLibrary.simpleMessage("解锁全新的AI使用体验 ->"),
        ...
        "setup_pre_warning":
            MessageLookupByLibrary.simpleMessage("在开始之前，请先注意："),
        "setup_provider_add": MessageLookupByLibrary.simpleMessage("让我们先添加提供商"),
        "setup_provider_add_hint":
            MessageLookupByLibrary.simpleMessage("你可以查看右边的教程来了解为什么需要以及如何添加"),
        ...
        "show_knowledge_base_results":
            MessageLookupByLibrary.simpleMessage("查看检索结果"),
        ...
        "support_formats":
            MessageLookupByLibrary.simpleMessage("支持md,docx,csv,txt,json,html"),
        "supports_files_api": MessageLookupByLibrary.simpleMessage("是否支持文件API"),
        "swipe_right_to_see_session":
            MessageLookupByLibrary.simpleMessage("向右滑动条目预览会话"),
        ...
        "toggle_session_selector":
            MessageLookupByLibrary.simpleMessage("打开会话选择器菜单"),
        ...
        "ui_interaction_set":
            MessageLookupByLibrary.simpleMessage("UI交互(BETA)设置"),
        "ui_interactions": MessageLookupByLibrary.simpleMessage("UI操作"),
        "ui_interactions_tokens": m27,
        "unknown": MessageLookupByLibrary.simpleMessage("未知"),
        "unsaved_changes_message":
            MessageLookupByLibrary.simpleMessage("检测到未保存的更改，是否在退出前保存？"),
        ...
        "vec_index_hint":
            MessageLookupByLibrary.simpleMessage("搜索和输入最相似的内容的片段并发送给模型"),
        "vector_index": MessageLookupByLibrary.simpleMessage("向量索引"),
        "version_preview":
            MessageLookupByLibrary.simpleMessage("V 1.0 Beta 预览版"),
        "video": MessageLookupByLibrary.simpleMessage("视频"),
        "view_all_provider_provide_model":
            MessageLookupByLibrary.simpleMessage("查看所有提供此模型的提供者"),
