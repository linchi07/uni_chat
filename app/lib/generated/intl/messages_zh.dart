...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(branch) => "分支自：${branch}";

  static String m3(branch) => "派生分支:${branch}";

  static String m4(dbName, from, to) =>
      "${dbName}发生降级：试图使用旧版本(${to})的应用打开高版本(${from})的数据库";

  static String m5(provider) => "编辑提供商：${provider}";

  static String m6(email) => "电子邮箱：${email}";

  static String m7(endPoint) => "端点";

  static String m8(endPoint) => "端点：${endPoint}";

  static String m9(error) => "发生错误:${error}";

  static String m10(condition) => "在${condition}时";

  static String m11(token) => "知识库（${token}Tokens）";

  static String m12(errorContent) => "加载错误${errorContent}";

  static String m13(error) => "读取日志失败: ${error}";

  static String m14(token) => "最长的开场白（${token}Tokens）";

  static String m15(num) => "已配置${num}个模型";

  static String m16(charCount, maxCount) =>
      "你已超出最大系统提示词上限，多余部分将会被截断，请增大模型上下文或者精简提示词${charCount}/${maxCount}";

  static String m17(provider) => " 确定删除提供商${provider}吗？\\n 一切记录和Key都会被一同删除";

  static String m18(num) => "选择了${num}个Agent";

  static String m19(token) => "内建提示词（${token}Tokens）";

  static String m20(token) => "系统提示词（${token}Tokens）";

  static String m21(token) => "可用于对话的Token：${token}";

  static String m22(lim) => "总上下文上限：${lim}";

  static String m23(type) => "类型:${type}";

  static String m24(token) => "UI交互提示词（${token}Tokens）";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "enter_sys_prompt_here":
            MessageLookupByLibrary.simpleMessage("在这里输入系统提示词"),
